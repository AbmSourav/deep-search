    ...
    useEffect(() => {
        if (dsAdmin?.currentPHPVersion < dsAdmin?.minPHPVersion) {
            ...
            setNotice({
                ...
                message: sprintf(
                    __(
                        'Deep Search requires PHP version %s or higher. Please upgrade your PHP version.',
                        'deep-search'
                    ),
                    dsAdmin?.minPHPVersion
                ),
            })
            return
        }
            ...
            <div className="ds-configs">
                <TabPanel
                    tabs={[
                        {
                            name: 'configurations',
                            title: __('Configurations', 'deep-search'),
                        },
