...
import { BaseControl, FontSizePicker, PanelBody, ToggleControl, __experimentalSpacer as Spacer } from '@wordpress/components';
        ...
        <>
            ...
            <InspectorControls group="styles">
                ...
                <PanelBody title={ __( 'Search Result', 'deep-search' ) }>
                    ...
                    <Spacer marginTop={4}>
                        <BaseControl className='ds-font-size' style={{marginTop: '15px'}}>
                            <p>{__('Title Font Size', 'deep-search')}</p>
                            <FontSizePicker
                            fontSizes={fontSizes}
                            fallbackFontSize={30}
                            value={attributes?.postTitleFontSize}
                            onChange={(fontSize) => setAttributes({postTitleFontSize: fontSize})}
                            className={'testsss'}
                            />
                        </BaseControl>
                    </Spacer>
                            ...
                            colorSettings={[
                                {
                                    ...
                                    onChange: (colorValue) => setAttributes({ paginationBtnBg: colorValue }),
                                    label: __('Background Color', 'deep-search'),
                                },
                                {
                                    value: attributes?.paginationBtnColor,
                                    onChange: (colorValue) => setAttributes({ paginationBtnColor: colorValue }),
